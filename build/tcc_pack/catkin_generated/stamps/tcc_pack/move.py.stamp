...
def main():
	...
	visits_table.to_csv('./results/T1_DONE/visits_' + str(ts) + '_.csv', index = False, mode = 'a', header = False)
	time_table.to_csv('./results/T1_DONE/time_' + str(ts) +'_.csv', index = False, mode = 'a', header = False)
	print('Test Over')
