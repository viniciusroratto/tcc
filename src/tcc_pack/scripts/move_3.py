...
def main():
	...
	visits_table.to_csv('./results/T3/visits_' + str(ts) + '_.csv', index = False, mode = 'a', header = False)
	time_table.to_csv('./results/T3/time_' + str(ts) +'_.csv', index = False, mode = 'a', header = False)
	print('Test Over')
